...
MACRO(MYSQL_ADD_PLUGIN plugin_arg)
  ...
  IF (WITH_${plugin} AND NOT ARG_MODULE_ONLY)
    ...
    IF(${target} STREQUAL "kvpmem")
      ...
      FIND_LIBRARY(PMEMKVJSON NAMES libpmemkv_json_config.so HINTS ${CMAKE_SOURCE_DIR}/storage/pmemkv/extra/pmemkv/build/)
      FIND_LIBRARY(PMEMKV NAMES libpmemkv.so HINTS ${CMAKE_SOURCE_DIR}/storage/pmemkv/extra/pmemkv/build/)
      target_link_libraries(${target} PUBLIC ${PMEMKV})
      target_link_libraries(${target} PUBLIC ${PMEMKVJSON})
      target_include_directories(${target} PUBLIC ${CMAKE_SOURCE_DIR}/storage/kvpmem/extra/pmemkv/src)
    ENDIF()
