...
MACRO(MYSQL_ADD_PLUGIN plugin_arg)
  ...
  IF (WITH_${plugin} AND NOT ARG_MODULE_ONLY)
    ...
    IF(${target} STREQUAL "kvpmem")
      ...
      FIND_LIBRARY(PMEMKVJSON NAMES libpmemkv_json_config.so HINTS ${CMAKE_SOURCE_DIR}/storage/kvpmem/extra/pmemkv/build/)
      FIND_LIBRARY(PMEMKV NAMES libpmemkv.so HINTS ${CMAKE_SOURCE_DIR}/storage/kvpmem/extra/pmemkv/build/)
