...
class KVpmem_share : public Handler_share {
 public:
  ...
  std::unordered_map<unsigned long, std::vector<pmem::kv::string_view>>
      subquery_stack_map;
...
class ha_kvpmem : public handler {
 ...
 public:
   ...
   */
  const char *table_type() const override { return "KVPMEM"; }
  ...
  */
  /** @brief
    We implement this in ha_kvpmem.cc; it's a required method.
  */
  ...
  */
  ...
  /** @brief
    We implement this in ha_kvpmem.cc. It's not an obligatory method;
